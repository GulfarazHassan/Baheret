...
export class CandidatesScreen extends React.Component {
  ...
  render() {
    ...
    if (this.props.showMutualMatchScreen) {
      ...
      return (
        <View
          style={{ flex: 1, alignSelf: "center", backgroundColor: "#F4F4F4" }}>
          <Text
            style={{
              fontWeight: "bold",
            ...
            Mazal Tov You Matched With {this.props.candidate.name}
          </Text>
        </View>
      );
      ...
      return (
        <View
          style={{ flex: 1, alignSelf: "stretch", backgroundColor: "#f4f4f4" }}>
          <TouchableOpacity
            style={{
              flex: 1,
              borderRadius: 20,
            ...
            <ImageBackground
              ...
              source={{ uri: this.props.candidate.profilePhoto }}>
              <View style={{}}>
                <View style={{}}>
                  <Text
                    style={{
