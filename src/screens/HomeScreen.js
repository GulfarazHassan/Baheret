...
export class HomeScreen extends React.Component {
  ...
  render() {
    ...
    if (!this.props.location) {
      renderComponent = (
        <Text>
          Oops, looks like we dont have access to your location. Please go to
          your settings to change this!
        </Text>
      );
    ...
    let candidatesIcon = (
      <SimpleLineIcons name='people' size={27} color='white' />
    );

    let matchmakerIcon = <Ionicons name='ios-heart' size={32} color='white' />;

    return (
      <View
        style={{ flex: 1, alignItems: "center", backgroundColor: "#F4F4F4" }}>
