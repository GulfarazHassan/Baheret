...
import { Permissions, Contacts } from "react-native-unimodules";
    ...
    return (
      <View style={{ flex: 1, backgroundColor: "#F4F4F4" }}>
        ...
        <View
          ...
          <TouchableOpacity
            style={styles.emptyCircleStyle}
            onPress={this.props.navigate}>
            <Feather name='plus' size={25} color='black' style={{}} />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.emptyCircleStyle}
            onPress={this.props.navigate}>
        ...
        <View
          ...
          <Text>Note: This feature is still under construction.</Text>
