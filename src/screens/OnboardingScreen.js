...
const captchaUrl = `https://fblogintest-18329.firebaseapp.com/?appurl=$`;
...
export class OnboardingScreen extends React.Component {
  ...
  validNumber = () => {
    ...
    if (phone == "") {
      ...
      const error =
        "Please check that you entered the correct number of digits";
      this.setState({ error });
      return false;
    } else {
      this.setState({ phone });
      ...
      return (
        <View style={styles.container}>
          <View
            ...
            <Text style={styles.loginLogoText}>Basheret</Text>
            {this.props.loggingIn && <ActivityIndicator />}
          </View>
          <View
            style={{ flex: 1, justifyContent: "flex-end", paddingBottom: 400 }}>
            <PhoneInput
              ref='phone'
            ...
            />
            <Button onPress={this.onPhoneComplete} title='Sign In' />
